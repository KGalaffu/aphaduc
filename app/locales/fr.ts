export default {
    ...
    cards: {
      card1: {
        ...
        description:
          "Découvrez comment nous soutenons les migrants et les personnes en voie de naturalisation à Genève et au Cameroun.",
        fullContent: `Nous sommes ravis de vous accueillir sur le site de l'**Association Aphaduc**, une organisation à but non lucratif dédiée à l'amélioration de la qualité de vie des migrants et des personnes en voie de naturalisation.
  ...
  Depuis notre création, nous avons développé une multitude d'initiatives et de programmes qui visent à soutenir les populations vulnérables, tant à Genève qu'au Cameroun. Grâce à nos ateliers, formations, et groupes de parole, nous favorisons l'échange, la connaissance, et le soutien mutuel entre les membres de notre communauté.
  ...
  Rejoignez-nous dans notre mission et découvrez comment vous pouvez contribuer à faire une différence. Ensemble, construisons un avenir meilleur, basé sur la solidarité, le respect, et l’inclusion.`,
      ...
      card2: {
        ...
        fullContent: `## Historique de l'Association
  ...
  Nous collaborons avec diverses organisations et institutions, tant au niveau local qu'international, pour renforcer nos initiatives et maximiser notre impact.`,
      ...
      card3: {
        ...
        fullContent: `## Centre d'Accueil et de Recherche APHADUC
  ...
  Ce programme représente une réponse systémique aux défis rencontrés par les jeunes migrants, en leur offrant les outils nécessaires pour réussir dans un environnement éducatif et social compétitif.`,
      ...
      card4: {
        ...
        description: "Découvrez comment nous aider dans nos projets.",
        fullContent: `## Faire un don
  
  Votre soutien financier est essentiel pour nous permettre de réaliser nos projets. Vous pouvez faire un don en ligne ou par virement bancaire.
  
  ## Devenir membre
  
  Rejoignez notre association en devenant membre. Vous contribuerez ainsi activement à notre mission et bénéficierez d'une plateforme pour vous engager.
  
  ## Bénévolat
  
  Nous sommes toujours à la recherche de bénévoles passionnés pour nous aider dans nos activités. Si vous souhaitez vous engager, n'hésitez pas à nous contacter.`,
      },
      card5: {
        title: "Ateliers et formations au Cameroun",
        description: "Découvrez nos ateliers au Cameroun",
        fullContent: `### 1. Ateliers de Sensibilisation à la Culture
  ...
  **Activités :**
  ...
  - Présentations de traditions locales
  - Échanges culturels adaptés aux jeunes
  - Cours de cuisine traditionnelle pour encourager la participation
  ...
  **Activités :**
  ...
  - Initiation à l'autonomie personnelle
  - Ateliers pratiques sur les soins d'hygiène et de santé
  ...
  **Activités :**
  ...
  - Sessions d'apprentissage avec des éducateurs spécialisés
  - Activités ludiques pour stimuler l'apprentissage
  ...
  **Activités :**
  ...
  - Ateliers sur les gestes de premiers secours
  - Séances de relaxation ou de yoga adaptées aux enfants
  ...
  **Activités :**
  ...
  - Formations sur les compétences techniques (artisanat, agriculture durable)
  - Cours d'entrepreneuriat axés sur des projets locaux
  ...
  **Activités :**
  ...
  - Activités de groupe pour favoriser la cohésion
  - Jeux de rôle sur la gestion des émotions
  - Formations sur les compétences sociales et interpersonnelles`,
      },
      card6: {
        title: "Ateliers et formations en Suisse",
        description: "Découvrez nos ateliers en Suisse",
        fullContent: `### Ateliers de Sensibilisation à la Culture
  
  **Objectif :** Favoriser l’intégration des jeunes migrants dans la société suisse.
  
  **Activités :**
  
  - Ateliers sur les coutumes suisses
  - Échanges culturels
  ...
  **Activités :**
  ...
  - Tutorat dans des matières scolaires (mathématiques, sciences)
  - Aide à la rédaction de devoirs
  ...
  **Activités :**
  ...
  - Formations sur les compétences techniques (informatique, métiers de la santé)
  - Cours sur la création d'entreprise
  ...
  **Activités :**
  ...
  - Séminaires avec des avocats sur les droits des migrants
  - Séances d’information sur l'accès à l'éducation
  ...
  **Activités :**
  ...
  - Formations sur les compétences interpersonnelles
