export default {
    hello: "Bonjour",
    subtitle: "Découvrez comment nous soutenons les migrants et les personnes en voie de naturalisation à Genève et au Cameroun",
    cards: {
      card1: {
        title: "Bienvenue sur le site de l'Association Aphaduc",
        description: "Découvrez comment nous soutenons les migrants et les personnes en voie de naturalisation à Genève et au Cameroun.",
  ...
  Rejoignez-nous dans notre mission et découvrez comment vous pouvez contribuer à faire une différence. Ensemble, construisons un avenir meilleur, basé sur la solidarité, le respect, et l’inclusion.`,
      ...
      card2: {
        ...
        description: "Découvrez notre mission et notre histoire, et comment nous avons impacté la vie de nombreux migrants à Genève et au Cameroun.",
  ...
  **Partenaires**
  ...
  Nous collaborons avec diverses organisations et institutions, tant au niveau local qu'international, pour renforcer nos initiatives et maximiser notre impact.`,
      ...
      card3: {
        title: "Nos projets",
        description: "Découvrez notre Centre d'Accueil et de Recherche au Cameroun ainsi que notre Programme d'Accompagnement pour les jeunes migrants.",
